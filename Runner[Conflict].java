 ...
 * inputs 6 integers and program calculates the aveerage) and Mad Libs (user
...
public class Runner
{
    public static void main(String[] args)
    {
         ...
         */
        int gameChoice = JOptionPane.showOptionDialog(null, "Hello, " + name + "! Which "
            + "game would you like to play?",null, JOptionPane.YES_NO_OPTION,
            JOptionPane.QUESTION_MESSAGE,null, gameOptions, gameOptions[0]);
        
        while (gameChoice == JOptionPane.YES_OPTION) //stats option chosen
            {    
            JOptionPane.showMessageDialog(null, "You will give me 6" + " integers." +
            ...
            */
            double firstInteger = Double.parseDouble((String)JOptionPane.showInputDialog(
                null,"First Integer:", "Customized Dialog", JOptionPane.PLAIN_MESSAGE, 
                null, null, null));
                ...
                if (secondInteger % 1 == 0)
                    ...
                    if (thirdInteger % 1 == 0)
                        ...
                        double fourthInteger = Double.parseDouble((String)JOptionPane.showInputDialog(
                            null, "Integers Chosen:" + firstIntegerString + " " + secondIntegerString 
                            + " " + thirdIntegerString, "Customized Dialog", JOptionPane.PLAIN_MESSAGE, 
                            null, null, null));
                        ...
                        if (fourthInteger % 1 == 0)
                            {
                            double fifthInteger = Double.parseDouble((String)JOptionPane.showInputDialog(
                                null, "Integers Chosen:" + firstIntegerString + " " + secondIntegerString 
                                + " " + thirdIntegerString + " " + fourthIntegerString, "Customized Dialog", 
                            ...
                            if (fifthInteger % 1 == 0)
                                ...
                                if (sixthInteger % 1 == 0)
                                    {
                                        //must replace 6 with firstInteger
        ...
        while (gameChoice == JOptionPane.NO_OPTION) //mad libs option chosen
            {    
                ...
                JOptionPane.showMessageDialog(null, "How to play: I will ask" 
                    + " you for a specific kind of \nword (i.e. a noun," + 
                    " adjective," + " verb, and etc). Then, \nI will use your" 
                    + " words to make a" + " story.");
                
                /*
                 * Displays window to input words and assigns them to variables
                 */
                String choiceSeason = (String)JOptionPane.showInputDialog(
                null, "" + "A Season", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String firstAdjective = (String)JOptionPane.showInputDialog(
                null, "" + "Adjective", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String pluralNoun = (String)JOptionPane.showInputDialog(
                null, "" + "Plural Noun", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String firstVerb = (String)JOptionPane.showInputDialog(
                null, "" + "Verb", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String secondAdjective = (String)JOptionPane.showInputDialog(
                null, "" + "Adjective", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String bodyPart = (String)JOptionPane.showInputDialog(
                null, "" + "Body Part", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String thirdAdjective = (String)JOptionPane.showInputDialog(
                null, "" + "Adjective", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String secondVerb = (String)JOptionPane.showInputDialog(
                null, "" + "Verb", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String firstNoun = (String)JOptionPane.showInputDialog(
                null, "" + "Noun", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String thirdVerb = (String)JOptionPane.showInputDialog(
                null, "" + "Verb", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String secondBodyPart = (String)JOptionPane.showInputDialog(
                null, "" + "Body Part", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String fourthVerb = (String)JOptionPane.showInputDialog(
                null, "" + "Verb", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                
                String fourthAdjective = (String)JOptionPane.showInputDialog(
                null, "" + "Adjective", "Customized Dialog", 
                JOptionPane.PLAIN_MESSAGE, null, null, null);
                ...
                int playMadlibsAgain = JOptionPane.showOptionDialog(null,
                    "Would you like to play again?", null,
                    JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,
                    null, playMadLibsOptions, playMadLibsOptions[0]);
